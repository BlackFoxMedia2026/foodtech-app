...
export const CAPACITA_CERTIFICABILI: CapacitaCertificabile[] = [
  ...
  /* Letture dello storico della cassa: servono a dire «legge gli ordini e i pagamenti» con un'evidenza vera. */
  { chiave: "read_orders", etichetta: "Lettura ordini", capacitaPiattaforma: ["orders.read"], livelli: ["FIXTURE", "PROVIDER_API"], essenziale: false, effettoFiscalePossibile: false, richiedeHardware: false, richiedeMetodo: "getOrders" },
  { chiave: "read_payments", etichetta: "Lettura pagamenti", capacitaPiattaforma: ["payments.read"], livelli: ["FIXTURE", "PROVIDER_API"], essenziale: false, effettoFiscalePossibile: false, richiedeHardware: false, richiedeMetodo: "getPayments" },
