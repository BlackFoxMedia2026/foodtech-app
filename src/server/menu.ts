...
import { ALLERGENI, REGIMI, type Allergene, type Regime } from "@/lib/allergeni";
...
/*
  Gli allergeni e i regimi vivono in `lib/allergeni.ts`, senza dipendenze dal
  database: la comanda si batte da un componente client, che deve poter
  disegnare le stesse quattordici caselle senza tirarsi dietro Prisma.

  Si ri-esportano da qui perché mezzo progetto li importa da "@/server/menu",
  e soprattutto perché **due elenchi di allergeni che divergono** sono un
  cliente celiaco che legge quello sbagliato.
*/
export {
  ALLERGENI,
  REGIMI,
