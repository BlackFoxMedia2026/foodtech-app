        ...
        {/* Il margine sinistro era -16 con un asse da 32: le etichette,
          ...
          <defs>
            <linearGradient id="coversFill" x1="0" y1="0" x2="0" y2="1">
              <stop offset="0%" style={{ stopColor: "var(--trend-line)" }} stopOpacity={0.3} />
              <stop offset="100%" style={{ stopColor: "var(--trend-line)" }} stopOpacity={0} />
            </linearGradient>
          </defs>
          ...
          <Tooltip
            cursor={{ stroke: "var(--trend-line)", strokeOpacity: 0.3 }}
            contentStyle={{
              borderRadius: 8,
          ...
          <Area
            ...
            strokeWidth={2}
            fill="url(#coversFill)"
            dot={{ r: 3.5, fill: "var(--trend-line)", strokeWidth: 0 }}
            activeDot={{ r: 5, fill: "var(--trend-line)", strokeWidth: 0 }}
          />
        </AreaChart>
      </ResponsiveContainer>
    </div>
