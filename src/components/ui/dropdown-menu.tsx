...
/**
 * L'etichetta di un gruppo di voci: non è cliccabile e non prende il fuoco.
 * Serve alla navigazione secondaria, dove sette voci in fila si leggono una
 * per una invece di saltare al gruppo che c'entra.
 */
