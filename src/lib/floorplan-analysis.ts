...
const SINONIMI: [RegExp, AreaType][] = [
  ...
  [/BAGN|WC|TOILET|SERVIZI\b|SPOGLIAT/, "AREA_WC"],
  [/MAGAZZIN|DISPENS|DEPOSIT|RIPOSTIG|LAVANDER|STORAGE|CELLA|CANTIN/, "AREA_STORAGE"],
  [/PRIVAT|UFFICI|OFFICE|DIREZION/, "AREA_PRIVATE"],
