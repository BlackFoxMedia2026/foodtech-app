...
1. **Il motore di disponibilità** (`availability.ts`, 556 righe) — unica fonte di verità per sala, API e widget, rispetta il fuso del locale, raccoglie *tutti* i motivi di rifiuto, ha 65 verifiche automatiche. È il pezzo migliore del progetto.
