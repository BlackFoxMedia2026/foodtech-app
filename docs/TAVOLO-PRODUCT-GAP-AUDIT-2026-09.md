...
| Area | Stato | Evidenza |
|---|---|---|
| Motore disponibilità | **REAL** | 556 righe, unica fonte per sala/API/widget, 45 regole verificate `[CODE][PREVIOUS AUDIT]` |
...
| **Availability** | **9** | Unica fonte di verità server-side, 45 regole verificate, tutti i motivi di rifiuto raccolti | Proposta di alternative al cliente |
