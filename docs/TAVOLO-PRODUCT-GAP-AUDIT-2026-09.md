...
Assenti: RevPASH (**scelta dichiarata**: pochi giorni di incassi veri), rotazione tavoli, ricavo per cameriere, confronto fra locali, ROI della fedeltà, debito gift card nei numeri d'insieme (c'è nella sua pagina).
