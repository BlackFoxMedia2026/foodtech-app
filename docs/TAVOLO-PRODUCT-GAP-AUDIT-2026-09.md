...
| 5 | **CRM non condiviso fra locali** | Per una catena è il requisito che chiude la trattativa | CoverManager (*One CRM, every guest*) | Cliente, punti e gift card a livello di organizzazione — **tre strade a confronto in [`docs/NOTA-CRM-FRA-LOCALI.md`](NOTA-CRM-FRA-LOCALI.md)**, con quello che non si può più disfare e la riga SQL per misurare quanti clienti sono davvero in comune | **L** | **P1** |
