...
| Coupon | LIVE | Codice leggibile al telefono, sconto in percentuale o in euro o omaggio, tetti d'uso totali e per cliente, validità, pausa e archivio. Si usano al tavolo dalla scheda della prenotazione, con il motivo scritto quando un codice non vale; l'utilizzo si annulla e il coupon torna disponibile. Due camerieri contemporanei non superano il tetto |
...
| Raccolta punti | LIVE | Punti guadagnati **sui conti chiusi** (euro veri, non stimati). Le due regole le dichiara il locale in Impostazioni — punti per euro e valore di un punto — e senza entrambe la raccolta è spenta invece di regalare sconti decisi da noi. Si usano come sconto dal conto al tavolo; sulla scheda del cliente ci sono saldo, valore in euro e la storia dei movimenti, con la correzione a mano che pretende un motivo scritto. La verità è la somma delle righe, `Guest.loyaltyPoints` è solo una copia |
...
| Test | PARTIAL | 562 verifiche: permessi, isolamento, fuso, limiti, registro, disponibilità, waitlist, walk-in, forzatura, promemoria, link firmati, fotografia del servizio stati vivi della sala, regole del centro controllo, profilo ospite, sondaggi, coda dei lavori, invio campagne, automazioni, freno sulle migrazioni, previsione coperti, attribuzione delle campagne, tavolate, esperienze, coupon, omaggi automatici, paginazione, menu, conto del tavolo, costo del cibo, raccolta punti, gift card, numerazione dei conti, portale Wi-Fi, riconoscimento del cliente motivo obbligatorio sulle forzature cancellazione ed esportazione dei dati su richiesta, stato delle campagne programmate, vista settimana e costo delle assenze. Nessun end-to-end sul browser automatizzato (le verifiche dal vivo si fanno a mano, con gli screenshot in `docs/audit-2026-09/`) |
